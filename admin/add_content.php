...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($content)) {
        ...
        $success = addContent($conn, $title, $content, $image, $_SESSION['user_id']);
        if ($success) {
            ...
            $message = 'Terjadi kesalahan saat menambahkan konten.';
            $messageType = 'danger';
        }
    }
}
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0 fw-bold">Tambah Konten Baru</h2>
                ...
                <div class="card-body p-4">
                    <form method="post" action="add_content.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="image" name="image" placeholder="Masukkan URL gambar (opsional)">
